...
class MotionDetector:
    def __init__(self,
                 ...
                 expansion_step=1):
        """
        movement_frames_history tells us what amount of frames to use for current movement (to decrease the noise)
        brightness_discard_level tells us if the pixel brightness is lower than this threshold, it's background
        """
